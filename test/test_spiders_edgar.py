...
class EdgarSpiderTest(TestCaseBase):
    ...
    def test_parse_company_filing_page(self):
        ...
        '''
        dict = {'start_date':'20160101', 'end_date': '20161104'}
        spider = EdgarSpider(**dict)
        ...
        response = HtmlResponse('http://sec.gov/mock', body=body, encoding='utf-8')
    ...
    def test_parse_xml_report(self):
        ...
        body = '''
            ...
            <xbrl xmlns="http://www.xbrl.org/2003/instance"
             ...
             https://doc.scrapy.org/en/latest/topics/contracts.html <us-gaap:EarningsPerShareBasic contextRef="c1">0.2</us-gaap:EarningsPerShareBasic>
        ...
        response = XmlResponse('http://sec.gov/Archives/edgar/data/123/abc-20130720.xml', body=body, encoding='utf-8')
