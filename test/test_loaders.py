...
def create_response(file_path):
    ...
    with open(file_path) as f:
        body = f.read()
    return XmlResponse('file:///{}'.format(file_path.replace('\\', '/')), body=body, encoding='utf-8')
...
class ReportItemLoaderTest(TestCaseBase):
    ...
    @pytest.mark.skip(reason='failing and idc really why right now')
    ...
    @pytest.mark.skip(reason='failing and idc really why right now. Something about the cleaning of the xml')
