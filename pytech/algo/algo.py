...
class Algorithim(metaclass=ABCMeta):
    ...
    def __init__(self, *args, **kwargs):
        self.start_date = kwargs.pop('start_date', dt_utils.get_default_date(
            is_start_date=True))
        self.end_date = kwargs.pop('end_date', dt_utils.get_default_date(
            is_start_date=False))
        self.environment = kwargs.pop('env', Environment())
        self.asset_finder = kwargs.pop('asset_finder',
                                       self.environment.asset_finder)
