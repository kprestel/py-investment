...
class AlgoParams(object):
    ...
    def __init__(self, starting_capital, start_date=None, end_date=None, commission_model=None):
        ...
        self.blotter = Blotter(portfolio=self.portfolio, commission_model=commission_model)
