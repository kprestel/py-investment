...
from pytech.utils.enums import TradeAction, OrderType, OrderSubType
...
assets = sa.Table(
    ...
    sa.Column("last_updated", TIMESTAMP(timezone=True), server_onupdate=utcnow()),
)
...
transaction = sa.Table(
    ...
    sa.Column("portfolio_id", None, sa.ForeignKey("portfolio.id"), primary_key=True),
...
if __name__ == "__main__":
    engine = sa.create_engine("postgresql://pytech:pytech@localhost/pytech", echo=True)
